...
data from sensors built with `fVDB <https://fvdb.ai>`_.
...
Overview
-------------
Analogous to how `torchvision <https://docs.pytorch.org/vision/stable/index.html>`_ builds a computer-vision specialized
toolbox on top of `PyTorch <https://pytorch.org/>`_, fVDB-Reality-Capture builds a reality-capture specialized toolbox on top of fVDB.
...
fVDB-Reality-Capture is built on top of the `fVDB <https://fvdb.ai>`_ library, which provides efficient GPU data structures and algorithms for
